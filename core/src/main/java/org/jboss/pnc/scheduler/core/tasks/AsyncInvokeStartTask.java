...
public class AsyncInvokeStartTask extends SynchronizedAsyncControllerTask {
    private WebClient client;
    private URI uri;
    private Service service;
    private ServiceControllerImpl controller;

    private static final Logger logger = LoggerFactory.getLogger(AsyncInvokeStartTask.class);


    public AsyncInvokeStartTask(TransactionManager tm, Service service, ServiceControllerImpl controller) {
        super(tm);
        this.service = service;
        this.controller = controller;
        try {
            this.uri = new URI(service.getRemoteEndpoints().getStartUrl());
