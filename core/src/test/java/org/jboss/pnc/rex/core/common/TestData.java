...
public class TestData {
    ...
    public static CreateTaskDTO getMockTaskWithoutStart(String name, Mode mode, boolean withNotifications) {
        ...
        if (withNotifications) {
            return getMockTask(
                    name,
                    mode,
                    getRequestWithoutStart(payload),
                    getStopRequestWithCallback(payload),
    ...
    public static CreateTaskDTO getMockTaskWithStart(String name, Mode mode, boolean withNotifications) {
        if (withNotifications) {
            return getMockTask(
                    name,
                    mode,
                    getRequestWithStart(name),
                    getStopRequestWithCallback(name),
                    getNotificationsRequest());
        }
    ...
    public static CreateTaskDTO getMockTask(
            String name,
            Mode mode,
            org.jboss.pnc.api.dto.Request startRequest,
            org.jboss.pnc.api.dto.Request stopRequest,
            org.jboss.pnc.api.dto.Request notificationsRequest) {
    ...
    public static Request getEndpointWithStart(String payload) {
        return Request.builder()
                ...
                .method(Method.POST)
                .headers(List.of(Header.builder().name("Content-Type").value("application/json").build()))
                .attachment(payload)
                .build();
    }
    ...
    public static CreateGraphRequest getComplexGraph(boolean withStart, boolean withNotifications) {
        ...
        return CreateGraphRequest.builder()
                ...
                .vertex(
                        a,
                        withStart ? getMockTaskWithStart(a, Mode.ACTIVE, withNotifications)
                                : getMockTaskWithoutStart(a, Mode.IDLE, withNotifications))
                .vertex(
                        b,
                        withStart ? getMockTaskWithStart(b, Mode.ACTIVE, withNotifications)
                                : getMockTaskWithoutStart(b, Mode.IDLE, withNotifications))
                .vertex(
                        c,
                        withStart ? getMockTaskWithStart(c, Mode.ACTIVE, withNotifications)
                                : getMockTaskWithoutStart(c, Mode.IDLE, withNotifications))
                .vertex(
                        d,
                        withStart ? getMockTaskWithStart(d, Mode.ACTIVE, withNotifications)
                                : getMockTaskWithoutStart(d, Mode.IDLE, withNotifications))
                .vertex(
                        e,
                        withStart ? getMockTaskWithStart(e, Mode.ACTIVE, withNotifications)
                                : getMockTaskWithoutStart(e, Mode.IDLE, withNotifications))
                .vertex(
                        f,
                        withStart ? getMockTaskWithStart(f, Mode.ACTIVE, withNotifications)
                                : getMockTaskWithoutStart(f, Mode.IDLE, withNotifications))
                .vertex(
                        g,
                        withStart ? getMockTaskWithStart(g, Mode.ACTIVE, withNotifications)
                                : getMockTaskWithoutStart(g, Mode.IDLE, withNotifications))
                .vertex(
                        h,
                        withStart ? getMockTaskWithStart(h, Mode.ACTIVE, withNotifications)
                                : getMockTaskWithoutStart(h, Mode.IDLE, withNotifications))
                .vertex(
                        i,
                        withStart ? getMockTaskWithStart(i, Mode.ACTIVE, withNotifications)
                                : getMockTaskWithoutStart(i, Mode.IDLE, withNotifications))
                .vertex(
                        j,
                        withStart ? getMockTaskWithStart(j, Mode.ACTIVE, withNotifications)
                                : getMockTaskWithoutStart(j, Mode.IDLE, withNotifications))
                .build();
    }
    ...
    public static CreateGraphRequest getComplexGraphWithoutEnd(boolean withStart, boolean withNotifications) {
        ...
        return CreateGraphRequest.builder()
                ...
                .vertex(
                        a,
                        withStart ? getMockTaskWithoutStart(a, Mode.ACTIVE, withNotifications)
                                : getMockTaskWithoutStart(a, Mode.IDLE, withNotifications))
                .vertex(
                        b,
                        withStart ? getMockTaskWithoutStart(b, Mode.ACTIVE, withNotifications)
                                : getMockTaskWithoutStart(b, Mode.IDLE, withNotifications))
                .vertex(
                        c,
                        withStart ? getMockTaskWithoutStart(c, Mode.ACTIVE, withNotifications)
                                : getMockTaskWithoutStart(c, Mode.IDLE, withNotifications))
                .vertex(
                        d,
                        withStart ? getMockTaskWithoutStart(d, Mode.ACTIVE, withNotifications)
                                : getMockTaskWithoutStart(d, Mode.IDLE, withNotifications))
                .vertex(
                        e,
                        withStart ? getMockTaskWithoutStart(e, Mode.ACTIVE, withNotifications)
                                : getMockTaskWithoutStart(e, Mode.IDLE, withNotifications))
                .vertex(
                        f,
                        withStart ? getMockTaskWithoutStart(f, Mode.ACTIVE, withNotifications)
                                : getMockTaskWithoutStart(f, Mode.IDLE, withNotifications))
                .vertex(
                        g,
                        withStart ? getMockTaskWithoutStart(g, Mode.ACTIVE, withNotifications)
                                : getMockTaskWithoutStart(g, Mode.IDLE, withNotifications))
                .vertex(
                        h,
                        withStart ? getMockTaskWithoutStart(h, Mode.ACTIVE, withNotifications)
                                : getMockTaskWithoutStart(h, Mode.IDLE, withNotifications))
                .vertex(
                        i,
                        withStart ? getMockTaskWithoutStart(i, Mode.ACTIVE, withNotifications)
                                : getMockTaskWithoutStart(i, Mode.IDLE, withNotifications))
                .vertex(
                        j,
                        withStart ? getMockTaskWithoutStart(j, Mode.ACTIVE, withNotifications)
                                : getMockTaskWithoutStart(j, Mode.IDLE, withNotifications))
                .build();
    }
}
